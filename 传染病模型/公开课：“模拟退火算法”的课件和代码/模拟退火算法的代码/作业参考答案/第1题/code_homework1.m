%% SA模拟退火: 求解函数y = 21.5+x(1)*sin(4*pi*x(1))+x(2)*sin(20*pi*x(2))在x1属于[-3,12.1]，x2属于[4.1,5.8]内的最大值(动画演示）
clear; clc  % 我求的最优值是：38.8503
...
scatter3(best_x(1), best_x(2), max_y,'*r');  % 在最大值处重新标上散点
