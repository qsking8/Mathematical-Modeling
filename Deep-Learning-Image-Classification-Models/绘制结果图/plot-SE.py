...
# 文件路径
file_paths = [
    r'C:\Users\65349\Desktop\mycode\Deep-Learning-Image-Classification-Models\训练记录\SE_ResNet18.csv',
    r'C:\Users\65349\Desktop\mycode\Deep-Learning-Image-Classification-Models\训练记录\SE_ResNet34.csv',
    r'C:\Users\65349\Desktop\mycode\Deep-Learning-Image-Classification-Models\训练记录\SE_ResNet50.csv'
]

# 读取并提取数据
dfs = [pd.read_csv(file_path) for file_path in file_paths]
models = ['SE_ResNet18', 'SE_ResNet34', 'SE_ResNet50']
